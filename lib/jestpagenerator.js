    ...
    requests.forEach(request => {
        ...
        if (requestBody) {
            if (requestBody.mode === 'raw') {
                ...
                requestData.formData = requestBody.formdata
                    ...
                    const contentTypeHeaderExists = request.request.header.some(header => {
                        return header.key === 'Content-Type' && header.value === 'multipart/form-data';
                    });
